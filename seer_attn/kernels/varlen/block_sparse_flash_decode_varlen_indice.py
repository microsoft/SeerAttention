...
def _split_kernel(
    ...
    stride_lse_b, stride_lse_h, stride_lse_split,
...
def _merge_kernel(
    ...
    lse_partial_ptr,
    o_ptr,
    lse_partial_stride_b, lse_partial_stride_h, lse_partial_stride_split,
...
def block_sparse_flash_decode_gqa_indice(
    q,
    k_cache,
    v_cache,
    cache_seqlens,
...
if __name__ == "__main__":
    ...
    triton_out = block_sparse_flash_decode_gqa_indice(
        Q,
        K,
        V,
        cache_seqlens,
    ...
    start = time.time()
    for _ in range(1000):
        block_sparse_flash_decode_gqa_indice(
            Q,
            K,
            V,
            cache_seqlens,

...
class SeerAttnPhi3Config(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`Phi3Model`]. It is used to instantiate a
    Phi3 model according to the specified arguments, defining the model architecture. Instantiating a configuration
    with the defaults will yield a similar configuration to that of
    Phi3-7B-beta [Phi3/Phi3-7B-beta](https://huggingface.co/Phi3/Phi3-7B-beta).
    ...
    >>> # Initializing a Phi3 style configuration
    >>> configuration = Phi32Config()

    >>> # Initializing a model from the Phi3-7B style configuration
    >>> model = Phi32Model(configuration)

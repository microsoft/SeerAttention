...
from seer_attn.qwen2.configuration_qwen2_seerattn import SeerAttnQwen2Config
    ...
    def forward(
        ...
        **kwargs,
        ...
        predict_mask = self.attn_gate(
            ...
            block_slice_mode=self.block_slice_mode,
        )
...
class SeerAttnQwen2PreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, nn.Linear):
            ...
            module.weight.data.normal_(mean=0.0, std=std)
        elif isinstance(module, Qwen2RMSNorm) or isinstance(module, RMSNorm):
            module.weight.data.fill_(1.0)


class SeerAttnQwen2Model(SeerAttnQwen2PreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`SeerAttnQwen2DecoderLayer`]

# Modified from huggingfac llama implementation
import math
...
from .utils import BaseModelOutputWithPastAndMask, CausalLMOutputWithPastAndMask
...
class LlamaSeerAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        q_, k_ = query_states.clone(), key_states.clone()
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        position_embeddings_ds = self.rotary_emb(hidden_states, position_ids_ds)


        # print("position_embeddings", position_embeddings[0].shape, position_embeddings[1].shape)
    ...
    def _update_causal_mask(
        ...
        if (
            ...
            casual_mask_ds = torch.nn.functional.max_pool2d(causal_mask, (self.config.gate_block_sizes, self.config.gate_block_sizes), stride=(self.config.gate_block_sizes, self.config.gate_block_sizes), ceil_mode=True)

        return causal_mask, casual_mask_ds


class LlamaForCausalLMSeerAttnInf(LlamaPreTrainedModel):

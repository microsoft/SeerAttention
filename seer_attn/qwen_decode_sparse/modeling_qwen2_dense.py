...
from .attention_forward_dense import flash_attention_forward
...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # if self.layer_idx == 0:
        #     print("q", q.shape, "k", k.shape, "v", v.shape, "qlen", q_len)
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        # unsqueeze(0) similar to prolong. 
...
class SeerDecodingQwen2ForCausalLM_Dense(Qwen2PreTrainedModel, GenerationMixin):
